...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: SITE_URL,
    type: 'website',
    images: [{ url: 'https://luxe-disparity-tracker.vercel.app/og.png', width: 1200, height: 630, alt: 'Luxe Tracker - Global Launch & Price Disparity' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    images: ['https://luxe-disparity-tracker.vercel.app/og.png'],
  },
  icons: {
